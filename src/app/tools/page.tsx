  ...
  if (error) {
    return (
      <div className="min-h-screen flex flex-col items-center justify-center">
        <h1 className="text-4xl font-bold text-white mb-4">Error Loading Tools</h1>
    ...
    <div className="min-h-screen">
      ...
      >
        ...
        <p className="text-gray-300 text-center mb-12 max-w-2xl mx-auto">
          Explore our comprehensive collection of cybersecurity tools and utilities. 
          From network scanning to penetration testing, these tools are essential for security professionals.
        </p>
      </motion.div>
      ...
      >
        {tools.length === 0 ? (
          <div className="text-center py-16">
            <h3 className="text-2xl font-semibold text-white mb-4">No Tools Yet</h3>
            <p className="text-gray-300 mb-8">Check back soon for new tools!</p>
            <Link href="/" className="px-6 py-3 bg-cyan-500 text-white rounded-lg hover:bg-cyan-600 transition-colors">
              Back to Home
            </Link>
          </div>
